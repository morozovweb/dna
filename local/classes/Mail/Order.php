...
class Order{
    ...
    function getData($bookingId){
        ...
        if($booking){
            ...
            if($booking->getGameId()){

                $game = \Itech\Dnavr\GameTable::getByPrimary($booking->getGameId())->fetchObject();
            ...
            $arData = [
                ...
                'PAYMENT_STATUS' => $booking->isPayed(),
                'BOOKING_GAME_MODE' => $booking->getGamemode()->getName(),
                'BOOKING_GAME_NAME' => $gameName,
                'BOOKING_DATE' => $booking->getDateStart()->format('l, F, jS'),
                'BOOKING_TIME' => $booking->getDateStart()->format('h:i A').' - '.$booking->getUserDataEnd()->format('h:i A'),
                'BOOKING_LOCATION_NAME' => $booking->getLocation()->getAddress(),
                'BOOKING_LOCATION_PHONE' => $booking->getLocation()->getPhone(),
                'QUANTITY' => $booking->getHeadsetsCount(),
                'SUBTOTAL' => $booking->getSubtotal() - $booking->getTaxes(),
                                          ...
                                          <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                             <tr style="padding:0;text-align:left;vertical-align:top">
                                                <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:0;text-align:left">
                                                   ...
                                                   <h1 style="Margin:0;Margin-bottom:24px;color:inherit;font-family:'Maven Pro',sans-serif;font-size:64px;font-weight:700;line-height:1;margin:0;margin-bottom:24px;padding:0;text-align:left;word-wrap:normal">DNA VR - Booking confirmation</h1>
                                                   <h4 style="Margin:0;Margin-bottom:24px;color:inherit;font-family:'Maven Pro',sans-serif;font-size:24px;font-weight:700;line-height:120%;margin:0;margin-bottom:24px;padding:0;text-align:left;word-wrap:normal">Please find all of your booking information below.</h4>
                                                   <table class="spacer" style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                      <tbody>
                                                         <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <td height="16px" style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:16px;font-weight:400;hyphens:auto;line-height:16px;margin:0;mso-line-height-rule:exactly;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">&#xA0;</td>
                                                                  ...
                                                                  <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                     <tr style="padding:0;text-align:left;vertical-align:top">
                                                                        <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:0;text-align:left">
                                                                           ...
                                                                           <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:10px;padding:0;text-align:left">{$data['CUSTOMER']}</p>
                                                                        </th>
                                                                     </tr>
                                                                  </table>
                                                               </th>
                                                                  ...
                                                                  <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                     <tr style="padding:0;text-align:left;vertical-align:top">
                                                                        <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:0;text-align:left">
                                                                           ...
                                                                           <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:10px;padding:0;text-align:left">{$data['EMAIL']}</p>
                                                                        </th>
                                                                     </tr>
                                                                  </table>
                                                               </th>
                                                                  ...
                                                                  <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                     <tr style="padding:0;text-align:left;vertical-align:top">
                                                                        <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:0;text-align:left">
                                                                           ...
                                                                           <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:10px;padding:0;text-align:left">{$data['PHONE']}</p>
                                                                        </th>
                                                                     </tr>
                                                                  </table>
                                                               </th>
                                                                  ...
                                                                  <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                     <tr style="padding:0;text-align:left;vertical-align:top">
                                                                        <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:0;text-align:left">
                                                                           ...
                                                                           <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:10px;padding:0;text-align:left">#{$data['BOOKING_ID']}</p>
                                                                        </th>
                                                                     </tr>
                                                                  </table>
                                                               </th>
                                                                  ...
                                                                  <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                     <tr style="padding:0;text-align:left;vertical-align:top">
                                                                        <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:0;text-align:left">
                                                                           ...
                                                                           <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:10px;padding:0;text-align:left">{$data['BOOKING_CREATE_DATE']}</p>
                                                                        </th>
                                                                     </tr>
                                                                  </table>
                                                               </th>
                                          ...
                                          <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                             <tr style="padding:0;text-align:left;vertical-align:top">
                                                <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:0;text-align:left">
                                                   ...
                                                   <p class="gray" style="Margin:0;Margin-bottom:20px;color:rgb(26, 26, 26);font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:20px;padding:0;text-align:center">
                                                            Dear Virtual Reality Explorer,  </p>
                                                            <p class="gray" style="Margin:0;Margin-bottom:10px;color:rgb(26, 26, 26);font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:20px;padding:0;text-align:center">
                                                            You can find all of your booking information below.
                                                             </p>
                                                            <p class="gray" style="Margin:0;Margin-bottom:10px;color:rgb(26, 26, 26);font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:20px;padding:0;text-align:center">
                                                            Please be aware that Virtual Reality experience is a live event like a cinema or theatre and once the booking is confirmed we can not accept reschedules or offer refunds for cancellations.  
                                                             </p>
                                                            <p class="gray" style="Margin:0;Margin-bottom:10px;color:rgb(26, 26, 26);font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:20px;padding:0;text-align:center">
                                                            In case you have any queries related to your booking, please call us on {$data['BOOKING_LOCATION_PHONE']} or email us at info@dnavr.co.uk.
                                                            </p>
                                                            <p class="gray" style="Margin:0;Margin-bottom:10px;color:rgb(26, 26, 26);font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:20px;padding:0;text-align:center">
                                                           If you would like your VR Masters to take pictures or videos for you please do not hesitate to ask! 
                                                            </p>
                                                            <p class="gray" style="Margin:0;Margin-bottom:10px;color:rgb(26, 26, 26);font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:20px;padding:0;text-align:center">
                                                           You can later post these pictures/videos and tag @dna_vr on Instagram for a chance to win a free visit! 
                                                            </p>
                                                            <p>&nbsp;</p>
                                                   
                                                   <h4 style="Margin:0;Margin-bottom:24px;color:inherit;font-family:'Maven Pro',sans-serif;font-size:24px;font-weight:700;line-height:120%;margin:0;margin-bottom:24px;padding:0;text-align:left;word-wrap:normal">Booking Information</h4>
                                                   <table class="spacer" style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                      <tbody>
                                                         <tr style="padding:0;text-align:left;vertical-align:top">
                                                   ...
                                                   <table style="border-collapse:separate;border-spacing:0 10px;display:table;padding:0;position:relative;text-align:left;vertical-align:top;width:100%" class="row">
                                                      <tbody>
                                                         <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th class="small-12 large-6 columns first" style="Margin:0 auto;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0 auto;padding:0;padding-bottom:16px;padding-left:0!important;padding-right:0!important;text-align:left;width:50%">
                                                               <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                  <tr style="padding:0;text-align:left;vertical-align:top">
                                                                     <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:0;text-align:left">
                                                                        <table class="row white-elem" style="background-color:#fefefe;border-collapse:collapse;border-radius:16px;border-spacing:0;display:table;margin-bottom:10px;padding:0;position:relative;text-align:left;vertical-align:top;width:100%">
                                                                           <tbody>
                                                                              <tr style="padding:0;text-align:left;vertical-align:top">
                                                                                 <th class="small-2 large-1 columns first" style="Margin:0 auto;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0 auto;padding:10px;padding-bottom:16px;padding-left:0!important;padding-right:0!important;text-align:left;width:8.33333%">
                                                                                    <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                                       <tr style="padding:0;text-align:left;vertical-align:top">
                                                                                          <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:10px;text-align:left"><img src="{$siteServerName}/assets/img/vr-icon.svg" alt style="-ms-interpolation-mode:bicubic;clear:both;display:block;max-width:100%;outline:0;text-decoration:none;width:auto"></th>
                                                                                       </tr>
                                                                                    </table>
                                                                                 </th>
                                                                                 <th class="small-10 large-5 columns last" style="Margin:0 auto;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0 auto;padding:10px;padding-bottom:16px;padding-left:0!important;padding-right:0!important;text-align:left;width:41.66667%">
                                                                                    <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                                       <tr style="padding:0;text-align:left;vertical-align:top">
                                                                                          <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:10px;text-align:left"><strong>{$data['BOOKING_GAME_MODE']}</strong><br>{$data['BOOKING_GAME_NAME']}</th>
                                                                                       </tr>
                                                                                    </table>
                                                                                 </th>
                                                                              </tr>
                                                                           ...
                                                                           <tbody>
                                                                              <tr style="padding:0;text-align:left;vertical-align:top">
                                                                                 <th class="small-2 large-1 columns first" style="Margin:0 auto;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0 auto;padding:10px;padding-bottom:16px;padding-left:0!important;padding-right:0!important;text-align:left;width:8.33333%">
                                                                                    <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                                       <tr style="padding:0;text-align:left;vertical-align:top">
                                                                                          <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:10px;text-align:left"><img src="{$siteServerName}/assets/img/Subtract.svg" alt style="-ms-interpolation-mode:bicubic;clear:both;display:block;max-width:100%;outline:0;text-decoration:none;width:auto"></th>
                                                                                       </tr>
                                                                                    </table>
                                                                                 </th>
                                                                                 <th class="small-10 large-5 columns last" style="Margin:0 auto;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0 auto;padding:10px;padding-bottom:16px;padding-left:0!important;padding-right:0!important;text-align:left;width:41.66667%">
                                                                                    <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                                       <tr style="padding:0;text-align:left;vertical-align:top">
                                                                                          <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:10px;text-align:left"><strong>{$data['BOOKING_DATE']}</strong><br>{$data['BOOKING_TIME']}</th>
                                                                                       </tr>
                                                                                    </table>
                                                                                 </th>
                                                                              </tr>
                                                                           ...
                                                                           <tbody>
                                                                              <tr style="padding:0;text-align:left;vertical-align:top">
                                                                                 <th class="small-2 large-1 columns first" style="Margin:0 auto;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0 auto;padding:10px;padding-bottom:16px;padding-left:0!important;padding-right:0!important;text-align:left;width:8.33333%">
                                                                                    <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                                       <tr style="padding:0;text-align:left;vertical-align:top">
                                                                                          <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:10px;text-align:left"><img src="{$siteServerName}/assets/img/pin.svg" alt style="-ms-interpolation-mode:bicubic;clear:both;display:block;max-width:100%;outline:0;text-decoration:none;width:auto"></th>
                                                                                       </tr>
                                                                                    </table>
                                                                                 </th>
                                                                                 <th class="small-10 large-5 columns last" style="Margin:0 auto;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0 auto;padding:10px;padding-bottom:16px;padding-left:0!important;padding-right:0!important;text-align:left;width:41.66667%">
                                                                                    <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                                       <tr style="padding:0;text-align:left;vertical-align:top">
                                                                                          <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:10px;text-align:left">{$data['BOOKING_LOCATION_NAME']}<br><a href="#" style="Margin:0;color:#261DEB;font-family:'Maven Pro',sans-serif;font-weight:400;line-height:16px;margin:0;padding:0;text-align:left;text-decoration:underline"></a></th>
                                                                                       </tr>
                                                                                    </table>
                                                                                 </th>
                                                                              </tr>
                                                                           ...
                                                                           <tbody>
                                                                              <tr style="padding:0;text-align:left;vertical-align:top">
                                                                                 ...
                                                                                 <th class="small-10 large-5 columns last" style="Margin:0 auto;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0 auto;padding:10px;padding-bottom:16px;padding-left:0!important;padding-right:0!important;text-align:left;width:41.66667%">
                                                                                    <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                                       <tr style="padding:0;text-align:left;vertical-align:top">
                                                                                          <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:10px;text-align:left">{$data['BOOKING_LOCATION_PHONE']}<br><a href="#" style="Margin:0;color:#261DEB;font-family:'Maven Pro',sans-serif;font-weight:400;line-height:16px;margin:0;padding:0;text-align:left;text-decoration:underline"></a></th>
                                                                                       </tr>
                                                                                    </table>
                                                                                 </th>
                                                                              </tr>
                                                            ...
                                                            <th class="small-12 large-6 columns last" style="Margin:0 auto;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0 auto;padding:0;padding-bottom:16px;padding-left:0!important;padding-right:0!important;text-align:left;width:50%">
                                                               <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                  <tr style="padding:0;text-align:left;vertical-align:top">
                                                                     <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:0;text-align:left">
                                                                        <table style="background-color:#fefefe;border-collapse:separate;border-radius:24px;border-spacing:30px 10px;margin-left:32px;padding:20px;text-align:left;vertical-align:top;width:calc(100% - 32px)" class="white-block">
                                                                         
                                                                      
                                                                           <tr style="padding:0;text-align:left;vertical-align:top">
                                                                              <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                                 <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:18px;font-weight:400;line-height:20px;margin:0;margin-bottom:10px;padding:0;text-align:left"><strong>Number of headsets</strong></p>
                                                                              </td>
                                                                              <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                                 <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:18px;font-weight:400;line-height:20px;margin:0;margin-bottom:10px;padding:0;text-align:right"><strong>{$data['QUANTITY']}</strong></p>
                                                                              </td>
                                                                           </tr>
                                                                           
                                                                           <tr style="padding:0;text-align:left;vertical-align:top">
                                                                              <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                                 <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:18px;font-weight:400;line-height:20px;margin:0;margin-bottom:10px;padding:0;text-align:left"><strong>Number of players</strong></p>
                                                                              </td>
                                                                              <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                                 <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:18px;font-weight:400;line-height:20px;margin:0;margin-bottom:10px;padding:0;text-align:right"><strong>{$data['PLAYERS']}</strong></p>
                                                                              </td>
                                                                           </tr>
                                                                     
                                                                     <tr style="padding:0;text-align:left;vertical-align:top">
                                                                              <td colspan="2" style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;background:#C4C4C4;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;height:1px;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word"></td>
                                                                           </tr>
                                                                           
                                                                           <tr style="padding:0;text-align:left;vertical-align:top">
                                                                              <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                                 <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:10px;padding:0;text-align:left">Subtotal</p>
                                                                              </td>
                                                                              <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                                 <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:10px;padding:0;text-align:right"><strong>£{$data['SUBTOTAL']}</strong></p>
                                                                              </td>
                                                                           </tr>
                                                                           ...
                                                                           <tr style="padding:0;text-align:left;vertical-align:top">
                                                                              <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                                 <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:10px;padding:0;text-align:left">VAT</p>
                                                                              </td>
                                                                              <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                                 <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:10px;padding:0;text-align:right"><strong>£{$data['TAXES']}</strong></p>
                                                                              </td>
                                                                           </tr>
                                                                           <tr style="padding:0;text-align:left;vertical-align:top">
                                                                              <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                                 <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:10px;padding:0;text-align:left"><strong>Total amount</strong></p>
                                                                              </td>
                                                                              <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                                 <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:10px;padding:0;text-align:right"><strong>£{$data['PRICE']}</strong></p>
                                                                              </td>
                                                                           </tr>
                                                                           <tr style="padding:0;text-align:left;vertical-align:top">
                                                                              <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                                 <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:10px;padding:0;text-align:left"><strong>Amount paid</strong></p>
                                                                              </td>
                                                                              <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                                 <p style="Margin:0;Margin-bottom:10px;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:10px;padding:0;text-align:right"><strong>£{$data['PAID']}</strong></p>
                                                                              </td>
                                                                           </tr>
                                                                        </table>
                                                                     </th>
                                                   ...
                                                   <table style="border-collapse:separate;border-spacing:10px;display:table;padding:0;position:relative;text-align:left;vertical-align:top;width:100%" class="row">
                                                      <tbody>
                                                         <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <th class="small-12 large-5 columns first" style="Margin:0 auto;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0 auto;padding:0;padding-bottom:0;padding-left:0!important;padding-right:0!important;text-align:left;width:41.66667%">
                                                               <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                  <tr style="padding:0;text-align:left;vertical-align:top">
                                                                     <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:0;text-align:left">
                                                                        <table class="button btn btn_gradient expand" style="Margin:0 0 16px 0;border-collapse:collapse;border-spacing:0;margin:0 0 16px 0;padding:0;text-align:left;vertical-align:top;width:100%!important">
                                                                           <tr style="padding:0;text-align:left;vertical-align:top">
                                                                              <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                                 <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                                    <tr style="padding:0;text-align:left;vertical-align:top">
                                                                                       <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;background:0 0!important;border:2px solid transparent;border-collapse:collapse!important;border-color:transparent;color:#fefefe;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                                          <center data-parsed style="min-width:none!important;width:100%"><a href="{$siteServerName}/bookings/" align="center" class="float-center" style="Margin:0;background:0 0!important;border:2px solid #1A1A1A;border-color:#1A1A1A;border-radius:32px;box-sizing:border-box;color:#1A1A1A!important;display:inline-block;font-family:'Maven Pro',sans-serif;font-size:18px;font-weight:700;line-height:16px;margin:0;padding:17px 40px 17px 40px;padding-left:0;padding-right:0;text-align:center;text-decoration:none;width:100%" >view booking</a></center>
                                                                                       </td>
                                                                                    </tr>
                                                                                 </table>
                                                                              </td>
                                                   ...
                                                   <table class="row" style="border-collapse:collapse;border-spacing:0;display:table;padding:0;position:relative;text-align:left;vertical-align:top;width:100%">
                                                      <tbody>
                                                         <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <p class="gray" style="Margin:0;Margin-bottom:10px;color:#C4C4C4;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;margin-bottom:20px;padding:0;text-align:center">No refunds for cancellations and no shows</p>
                                                         </tr>
                                                      </tbody>
                                                   </table>
                                                </th>
...
ENDHTML;
    ...
    function getTemplateChange($data){
                                          ...
                                          <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                             <tr style="padding:0;text-align:left;vertical-align:top">
                                                <th style="Margin:0;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;line-height:16px;margin:0;padding:0;text-align:left">
                                                   ...
                                                   <h1 style="Margin:0;Margin-bottom:24px;color:inherit;font-family:'Maven Pro',sans-serif;font-size:64px;font-weight:700;line-height:1;margin:0;margin-bottom:24px;padding:0;text-align:left;word-wrap:normal">Your booking with DNA VR has been updated</h1>
                                                   <h4 style="Margin:0;Margin-bottom:24px;color:inherit;font-family:'Maven Pro',sans-serif;font-size:24px;font-weight:700;line-height:120%;margin:0;margin-bottom:24px;padding:0;text-align:left;word-wrap:normal">Please find the updated details below.</h4>
                                                   <table class="spacer" style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                      <tbody>
                                                         <tr style="padding:0;text-align:left;vertical-align:top">
                                                            <td height="16px" style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:16px;font-weight:400;hyphens:auto;line-height:16px;margin:0;mso-line-height-rule:exactly;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">&#xA0;</td>
...
ENDHTML;
    ...
    function getTemplateChangeNotPay($data){
                                                                           ...
                                                                           <tr style="padding:0;text-align:left;vertical-align:top">
                                                                              <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#1A1A1A;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                                 <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                                                                    <tr style="padding:0;text-align:left;vertical-align:top">
                                                                                       <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;background:0 0!important;border:2px solid transparent;border-collapse:collapse!important;border-color:transparent;color:#fefefe;font-family:'Maven Pro',sans-serif;font-size:14px;font-weight:400;hyphens:auto;line-height:16px;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word">
                                                                                          <center data-parsed style="min-width:none!important;width:100%"><a href="{$siteServerName}{$data['PAY_URL']}" align="center" class="float-center" style="Margin:0;background:0 0!important;border:2px solid #1A1A1A;border-color:#1A1A1A;border-radius:32px;box-sizing:border-box;color:#1A1A1A!important;display:inline-block;font-family:'Maven Pro',sans-serif;font-size:18px;font-weight:700;line-height:16px;margin:0;padding:17px 40px 17px 40px;padding-left:0;padding-right:0;text-align:center;text-decoration:none;width:100%" >pay now</a></center>
                                                                                       </td>
                                                                                    </tr>
                                                                                 </table>
                                                                              </td>
...
ENDHTML;
    ...
    function getTemplateNotPay($data){
...
ENDHTML;
    ...
    function sendNewBooking($id,$sendAdmin=true){

        $dataJson = $this->getData($id);

        //записываем логи в файл для проверки отправки письма
        $checkFile = $_SERVER["DOCUMENT_ROOT"] . '/' . 'emailTransactCheck.txt';
        ...
        $arInsert = [
            "start_log" => true,
            "date" => $curDate,
            "booking_create_date" => $dataJson['BOOKING_CREATE_DATE'],
            "entity_id" => $dataJson['BOOKING_ID'],
            "price_transact" => $dataJson['PRICE'],
            "user_email" => $dataJson['EMAIL']
        ];

        $arContent = file_get_contents($checkFile, true);

        $rsContent = file_put_contents($checkFile, PHP_EOL . json_encode($arInsert), FILE_APPEND);

        if($data = $this->getData($id)){

            $html = $this->getTemplate($data);

            \CEvent::Send("ITECH_NEW_BOOKING", ['s1'], [
                'EMAIL' => $data['EMAIL'],
                'HTML' => $html
            ]);

            if($sendAdmin){
                \CEvent::Send("ITECH_NEW_BOOKING_ADM", ['s1'], [
                    'EMAIL' => $data['EMAIL'],
                    'HTML' => $html
                ]);
            }
    ...
    function sendNewBookingNotPay($id,$hash,$sendAdmin=true){

        if($data = $this->getData($id)){

            $data['PAY_URL'] = '/pay/?key='.$hash;

            $html = $this->getTemplateNotPay($data);
    ...
    function sendNewBookingChange($id = false, $hash = false){

        if($data = $this->getData($id)){

            //если оплачено, то отправляем шаблон уже оплаченный, если нет, то шаблон с оплатой
            if ($data['PAYMENT_STATUS']) {

                $html = $this->getTemplateChange($data);

            } else {

                $data['PAY_URL'] = '/pay/?key='.$hash;

                $html = $this->getTemplateChangeNotPay($data);
